...
class Signin extends CI_Controller {
    ...
    function authenticate($email) {
        ...
        $id_user = $this->Users_model->login_user_id();
        $id_cliente = $this->Users_model->get_one($id_user)->client_id;
		$this->Logs_model->add_log($id_cliente, NULL, NULL, NULL, 'logged_in');
    ...
    function sign_out() {
        ...
        // LOG ACTION buld_uploaded
        $id_user = $this->Users_model->login_user_id();
        $id_cliente = $this->Users_model->get_one($id_user)->client_id;
		$this->Logs_model->add_log($id_cliente, NULL, NULL, NULL, 'logged_out');

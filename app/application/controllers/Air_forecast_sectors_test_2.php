 ...
 * @version 1.0
 */
class Air_forecast_sectors_test extends MY_Controller {
    ...
    function index($id_sector) {
		...
		$air_sector = $this->Air_sectors_model->get_one($id_sector_decrypt);
		...
		if(in_array(3, $id_models_of_sector)){
			...
			foreach($sector_variables as $variable){
				if($variable->id_variable != 9){ continue; } // MP10
			...
			foreach($sector_variables as $variable){
				if($variable->id_variable != 1 && $variable->id_variable != 2){ continue; } // VEL Y DIR VIENTO
			...
			$receptors = $this->Air_stations_model->get_all_where(array(
			...
			$id_report_unit_setting_qual = $this->Reports_units_settings_model->get_one_where(array(
			...
			$id_report_unit_setting_meteo = $this->Reports_units_settings_model->get_one_where(array(
				"id_cliente" => $id_cliente, 
				"id_proyecto" => $id_proyecto, 
			...
			if($air_quality_variable->id){
				...
				// $qual_values_p = $this->Air_records_values_p_model->get_values_details(array(
				// 	"id_variable" => $air_quality_variable->id,
				// 	"id_sector" => $air_sector->id,
				// 	//"last_upload" => true,
				...
				// $qual_values_p_last_upload = $this->Air_records_values_p_model->get_values_details(array(
				// 	"id_variable" => $air_quality_variable->id,
				// 	"id_sector" => $air_sector->id,
				// 	"last_upload" => true,
				// 	//"first_date" => $first_date_map,
				...
				// 		"time_00" => $value_p->time_00 < 15 ? 15 : $value_p->time_00, "time_01" => $value_p->time_01 < 15 ? 15 : $value_p->time_01,  
				// 		"time_02" => $value_p->time_02 < 15 ? 15 : $value_p->time_02, "time_03" => $value_p->time_03 < 15 ? 15 : $value_p->time_03, 
				// 		"time_04" => $value_p->time_04 < 15 ? 15 : $value_p->time_04, "time_05" => $value_p->time_05 < 15 ? 15 : $value_p->time_05,  
				// 		"time_06" => $value_p->time_06 < 15 ? 15 : $value_p->time_06, "time_07" => $value_p->time_07 < 15 ? 15 : $value_p->time_07, 
				// 		"time_08" => $value_p->time_08 < 15 ? 15 : $value_p->time_08, "time_09" => $value_p->time_09 < 15 ? 15 : $value_p->time_09,  
				// 		"time_10" => $value_p->time_10 < 15 ? 15 : $value_p->time_10, "time_11" => $value_p->time_11 < 15 ? 15 : $value_p->time_11, 
				// 		"time_12" => $value_p->time_12 < 15 ? 15 : $value_p->time_12, "time_13" => $value_p->time_13 < 15 ? 15 : $value_p->time_13,  
				// 		"time_14" => $value_p->time_14 < 15 ? 15 : $value_p->time_14, "time_15" => $value_p->time_15 < 15 ? 15 : $value_p->time_15, 
				// 		"time_16" => $value_p->time_16 < 15 ? 15 : $value_p->time_16, "time_17" => $value_p->time_17 < 15 ? 15 : $value_p->time_17,  
				// 		"time_18" => $value_p->time_18 < 15 ? 15 : $value_p->time_18, "time_19" => $value_p->time_19 < 15 ? 15 : $value_p->time_19, 
				// 		"time_20" => $value_p->time_20 < 15 ? 15 : $value_p->time_20, "time_21" => $value_p->time_21 < 15 ? 15 : $value_p->time_21,  
				// 		"time_22" => $value_p->time_22 < 15 ? 15 : $value_p->time_22, "time_23" => $value_p->time_23 < 15 ? 15 : $value_p->time_23, 
				// 	);
				// }
				...
				$file_qual_data_values_p = fopen("files/air_forecast_sectors_test/array_qual_data_values_p.txt", "r");
				$array_qual_data_values_p = fgets($file_qual_data_values_p);
				$view_data["array_qual_data_values_p"] = $array_qual_data_values_p;
				// var_dump($array_qual_data_values_p);
				// exit();

				$array_qual_data_values_p_for_qual_max_value = json_decode($array_qual_data_values_p, true);
				$array_current_qual_max_value = array();
				foreach($array_qual_data_values_p_for_qual_max_value[$first_date_map] as $value){
			...
			if($meteorological_variable->id){
				...
				if($meteorological_variable->id == 1){ // VELOCIDAD DEL VIENTO
					...
					// $meteo_values_p = $this->Air_records_values_p_model->get_values_details(array(
					...
					// $meteo_values_p_last_upload = $this->Air_records_values_p_model->get_values_details(array(
					// 	"id_variable" => $meteorological_variable->id,
					// 	"id_sector" => $air_sector->id,
					// 	"last_upload" => true,
					// ))->result();
					...
					// $meteo_values_p_dir = $this->Air_records_values_p_model->get_values_details(array(
					...
					// $meteo_values_p_dir_last_upload = $this->Air_records_values_p_model->get_values_details(array(
					// 	"id_variable" => 2, // Dirección del viento
					// 	"id_sector" => $air_sector->id,
					// 	"last_upload" => true,
					// ))->result();
					...
					// 		"time_00" => $value_p_dir->time_00, "time_01" => $value_p_dir->time_01, "time_02" => $value_p_dir->time_02, "time_03" => $value_p_dir->time_03,
					// 		"time_04" => $value_p_dir->time_04, "time_05" => $value_p_dir->time_05, "time_06" => $value_p_dir->time_06, "time_07" => $value_p_dir->time_07,
					// 		"time_08" => $value_p_dir->time_08, "time_09" => $value_p_dir->time_09, "time_10" => $value_p_dir->time_10, "time_11" => $value_p_dir->time_11,
					// 		"time_12" => $value_p_dir->time_12, "time_13" => $value_p_dir->time_13, "time_14" => $value_p_dir->time_14, "time_15" => $value_p_dir->time_15,
					// 		"time_16" => $value_p_dir->time_16, "time_17" => $value_p_dir->time_17, "time_18" => $value_p_dir->time_18, "time_19" => $value_p_dir->time_19,
					// 		"time_20" => $value_p_dir->time_20, "time_21" => $value_p_dir->time_21, "time_22" => $value_p_dir->time_22, "time_23" => $value_p_dir->time_23,
					// 	);
					...
					$file_meteo_data_values_p = fopen("files/air_forecast_sectors_test/array_meteo_data_values_p.txt", "r");
					$array_meteo_data_values_p = fgets($file_meteo_data_values_p);
					...
					$meteo_values_p_vel = $this->Air_records_values_p_model->get_values_details(array(
					...
					$meteo_values_p_vel_last_upload = $this->Air_records_values_p_model->get_values_details(array(
						"id_variable" => 1, // Velocidad del viento
						"id_sector" => $air_sector->id,
						"last_upload" => true,
					))->result();
					...
					/* foreach($meteo_values_p_vel as $value_p_vel){
						$array_meteo_data_values_p_vel[$value_p_vel->date][$value_p_vel->latitude.":".$value_p_vel->longitude] = array(
							"time_00" => $value_p_vel->time_00, "time_01" => $value_p_vel->time_01, "time_02" => $value_p_vel->time_02, "time_03" => $value_p_vel->time_03,
							"time_04" => $value_p_vel->time_04, "time_05" => $value_p_vel->time_05, "time_06" => $value_p_vel->time_06, "time_07" => $value_p_vel->time_07,
							"time_08" => $value_p_vel->time_08, "time_09" => $value_p_vel->time_09, "time_10" => $value_p_vel->time_10, "time_11" => $value_p_vel->time_11,
							"time_12" => $value_p_vel->time_12, "time_13" => $value_p_vel->time_13, "time_14" => $value_p_vel->time_14, "time_15" => $value_p_vel->time_15,
							"time_16" => $value_p_vel->time_16, "time_17" => $value_p_vel->time_17, "time_18" => $value_p_vel->time_18, "time_19" => $value_p_vel->time_19,
							"time_20" => $value_p_vel->time_20, "time_21" => $value_p_vel->time_21, "time_22" => $value_p_vel->time_22, "time_23" => $value_p_vel->time_23,
						);
					} */
                    foreach ($meteo_values_p_vel as $value_p_vel) {
                        $date = $value_p_vel->date;
                        $latLongKey = $value_p_vel->latitude . ":" . $value_p_vel->longitude;
                    
                        // Inicializar el array para la fecha actual si aún no existe
                        if (!isset($array_meteo_data_values_p_vel[$date])) {
                            $array_meteo_data_values_p_vel[$date] = [];
                        }
                    
                        // Inicializar el array para la clave latitud-longitud actual si aún no existe
                        if (!isset($array_meteo_data_values_p_vel[$date][$latLongKey])) {
                            $array_meteo_data_values_p_vel[$date][$latLongKey] = [];
                        }
                    
                        // Iterar sobre los tiempos
                        for ($i = 0; $i <= 23; $i++) {
                            $hour = str_pad($i, 2, '0', STR_PAD_LEFT); // Agregar ceros a la izquierda si es necesario
                            $timeKey = "time_$hour";
                    
                            // Asignar el valor al array dinámicamente
                            $array_meteo_data_values_p_vel[$date][$latLongKey][$timeKey] = $value_p_vel->$timeKey;
                        }
                    }
				...
				/* 	foreach($meteo_values_p as $value_p){
                    ...
                    foreach ($meteo_values_p as $value_p) {
                        $date = $value_p->date;
                        $latLongKey = $value_p->latitude . ":" . $value_p->longitude;
                    
                        // Inicializar el array para la fecha actual si aún no existe
                        if (!isset($array_meteo_data_values_p[$date])) {
                            $array_meteo_data_values_p[$date] = [];
                        }
                    
                        // Inicializar el array para la clave latitud-longitud actual si aún no existe
                        if (!isset($array_meteo_data_values_p[$date][$latLongKey])) {
                            $array_meteo_data_values_p[$date][$latLongKey] = [];
                        }
                        ...
                        for ($i = 0; $i <= 23; $i++) {
                            ...
                            // Construir la estructura del array para cada tiempo
                            $array_meteo_data_values_p[$date][$latLongKey]["time_$hour"] = array(
                                "velocity" => $array_meteo_data_values_p_vel[$date][$latLongKey]["time_$hour"],
                                "direction" => $value_p->{"time_$hour"}
                            );
                        }
                    }
					...
					/* foreach($meteo_values_p as $value_p){
						$array_meteo_data_values_p[$value_p->date][$value_p->latitude.":".$value_p->longitude] = array(
							"time_00" => $value_p->time_00, "time_01" => $value_p->time_01, "time_02" => $value_p->time_02, "time_03" => $value_p->time_03,
							"time_04" => $value_p->time_04, "time_05" => $value_p->time_05, "time_06" => $value_p->time_06, "time_07" => $value_p->time_07,
							"time_08" => $value_p->time_08, "time_09" => $value_p->time_09, "time_10" => $value_p->time_10, "time_11" => $value_p->time_11,
							"time_12" => $value_p->time_12, "time_13" => $value_p->time_13, "time_14" => $value_p->time_14, "time_15" => $value_p->time_15,
							"time_16" => $value_p->time_16, "time_17" => $value_p->time_17, "time_18" => $value_p->time_18, "time_19" => $value_p->time_19,
							"time_20" => $value_p->time_20, "time_21" => $value_p->time_21, "time_22" => $value_p->time_22, "time_23" => $value_p->time_23,
						);
					} */
                    foreach ($meteo_values_p as $value_p) {
                        $date = $value_p->date;
                        ...
                        for ($i = 0; $i <= 23; $i++) {
                            ...
                            // Asignar el valor al array dinámicamente
                            $array_meteo_data_values_p[$date][$latLongKey][$timeKey] = $value_p->$timeKey;
                        }
                    }
			...
			if($meteorological_variable->id == 1 || $meteorological_variable->id == 2){ 
				...
				$id_report_unit_setting_meteo_vel = $this->Reports_units_settings_model->get_one_where(array(
					"id_cliente" => $id_cliente, 
					"id_proyecto" => $id_proyecto, 
				...
				$id_report_unit_setting_meteo_dir = $this->Reports_units_settings_model->get_one_where(array(
					"id_cliente" => $id_cliente, 
					"id_proyecto" => $id_proyecto, 
				...
				foreach($array_period as $date => $times){
					...
					if($air_record->id){
						...
						$value_p_vel = $this->Air_records_values_p_model->get_last_upload_data_1D_by_date(array(
							"id_variable" => 1, // VELOCIDAD DEL VIENTO
							"id_record" => $air_record->id,
							"date" => $date
						))->row();
						...
						if($value_p_vel->id){
							...
							foreach($value_p_vel as $field => $value){
								if(in_array($field, $times)){
									...
									if(strpos($field, "min") !== false || strpos($field, "max") !== false || strpos($field, "porc_conf") !== false) { continue; }
							...
							foreach($times as $index => $time){
								...
								if(strpos($time, "min") !== false || strpos($time, "max") !== false || strpos($time, "porc_conf") !== false) { continue; }
				...
				foreach($array_period as $date => $times){
					...
					if($air_record->id){
						...
						$value_p_dir = $this->Air_records_values_p_model->get_last_upload_data_1D_by_date(array(
							"id_variable" => 2, // DIRECCIÓN DEL VIENTO
							"id_record" => $air_record->id,
							"date" => $date
						))->row();
		...
		if(in_array(2, $id_models_of_sector)){
			...
			$receptors_dropdown = array("" => "-");
			foreach($receptors as $receptor){
				if($receptor->id == 5){ continue; } // No mostrar Estación Meteorológica
				$receptors_dropdown[$receptor->id] = $receptor->name;
			}
        ...
        $this->template->rander("air_forecast_sectors_test/index", $view_data);
	}
	...
	function get_data_variables(){
		...
		if($air_quality_variable->id){
            ...
            foreach ($qual_values_p as $value_p) {
                ...
                // Inicializar el array para la fecha actual si aún no existe
                if (!isset($array_qual_data_values_p[$date])) {
                    $array_qual_data_values_p[$date] = [];
                }
            
                // Inicializar el array para la clave latitud-longitud actual si aún no existe
                if (!isset($array_qual_data_values_p[$date][$latLongKey])) {
                    $array_qual_data_values_p[$date][$latLongKey] = [];
                }
                ...
                for ($i = 0; $i <= 23; $i++) {
                    ...
                    // Asignar el valor al array dinámicamente
                    $array_qual_data_values_p[$date][$latLongKey][$timeKey] = max($value_p->$timeKey, 15);
                }
            }
			$view_data["air_quality_variable"] = $air_quality_variable;
			$view_data["array_qual_data_values_p"] = $array_qual_data_values_p;
		...
		if($meteorological_variable->id){
			...
			/* 	$array_meteo_data_values_p_dir = array();
				foreach($meteo_values_p_dir as $value_p_dir){
					$array_meteo_data_values_p_dir[$value_p_dir->date][$value_p_dir->latitude.":".$value_p_dir->longitude] = array(
						"time_00" => $value_p_dir->time_00, "time_01" => $value_p_dir->time_01, "time_02" => $value_p_dir->time_02,
						"time_03" => $value_p_dir->time_03, "time_04" => $value_p_dir->time_04, "time_05" => $value_p_dir->time_05,
						"time_06" => $value_p_dir->time_06, "time_07" => $value_p_dir->time_07, "time_08" => $value_p_dir->time_08,
						"time_09" => $value_p_dir->time_09, "time_10" => $value_p_dir->time_10, "time_11" => $value_p_dir->time_11,
						"time_12" => $value_p_dir->time_12, "time_13" => $value_p_dir->time_13, "time_14" => $value_p_dir->time_14,
						"time_15" => $value_p_dir->time_15, "time_16" => $value_p_dir->time_16, "time_17" => $value_p_dir->time_17,
						"time_18" => $value_p_dir->time_18, "time_19" => $value_p_dir->time_19, "time_20" => $value_p_dir->time_20,
						"time_21" => $value_p_dir->time_21, "time_22" => $value_p_dir->time_22, "time_23" => $value_p_dir->time_23,
					);
				} */
                $array_meteo_data_values_p_dir = array();

                foreach ($meteo_values_p_dir as $value_p_dir) {
                    $date = $value_p_dir->date;
                    $latLongKey = $value_p_dir->latitude . ":" . $value_p_dir->longitude;
                
                    // Inicializar el array para la fecha actual si aún no existe
                    if (!isset($array_meteo_data_values_p_dir[$date])) {
                        $array_meteo_data_values_p_dir[$date] = [];
                    }
                
                    // Inicializar el array para la clave latitud-longitud actual si aún no existe
                    if (!isset($array_meteo_data_values_p_dir[$date][$latLongKey])) {
                        $array_meteo_data_values_p_dir[$date][$latLongKey] = [];
                    }
                    ...
                    for ($i = 0; $i <= 23; $i++) {
                        ...
                        // Asignar el valor al array dinámicamente
                        $array_meteo_data_values_p_dir[$date][$latLongKey][$timeKey] = $value_p_dir->$timeKey;
                    }
                }
          /*       
				foreach($meteo_values_p as $value_p){
 ...
 */
                ...
                // Asignar el valor al array dinámicamente
                $array_meteo_data_values_p_dir[$date][$latLongKey][$timeKey] = array(
                "velocity" => $value_p->$timeKey,
                "direction" => $array_meteo_data_values_p_dir[$date][$latLongKey]["time_$hour"]
            );
        }
    }
...
/* 
				...
				foreach($meteo_values_p_vel as $value_p_vel){
					$array_meteo_data_values_p_vel[$value_p_vel->date][$value_p_vel->latitude.":".$value_p_vel->longitude] = array(
						"time_00" => $value_p_vel->time_00, "time_01" => $value_p_vel->time_01, "time_02" => $value_p_vel->time_02,
						"time_03" => $value_p_vel->time_03, "time_04" => $value_p_vel->time_04, "time_05" => $value_p_vel->time_05,
						"time_06" => $value_p_vel->time_06, "time_07" => $value_p_vel->time_07, "time_08" => $value_p_vel->time_08, 
						"time_09" => $value_p_vel->time_09, "time_10" => $value_p_vel->time_10, "time_11" => $value_p_vel->time_11,
						"time_12" => $value_p_vel->time_12, "time_13" => $value_p_vel->time_13, "time_14" => $value_p_vel->time_14,
						"time_15" => $value_p_vel->time_15, "time_16" => $value_p_vel->time_16, "time_17" => $value_p_vel->time_17,
						"time_18" => $value_p_vel->time_18, "time_19" => $value_p_vel->time_19, "time_20" => $value_p_vel->time_20,
						"time_21" => $value_p_vel->time_21, "time_22" => $value_p_vel->time_22, "time_23" => $value_p_vel->time_23,
					);
 ...
 */
                ...
                // Construir el array dinámicamente
                $array_meteo_data_values_p[$date][$latLongKey]["time_$hour"] = [
                "velocity" => $array_meteo_data_values_p_vel[$date][$latLongKey]["time_$hour"],
                "direction" => $value_p->{"time_$hour"}
                ];
            }
			...
			/* 	foreach($meteo_values_p as $value_p){
					$array_meteo_data_values_p[$value_p->date][$value_p->latitude.":".$value_p->longitude] = array(
						"time_00" => $value_p->time_00, "time_01" => $value_p->time_01, "time_02" => $value_p->time_02,
						"time_03" => $value_p->time_03, "time_04" => $value_p->time_04, "time_05" => $value_p->time_05,
						"time_06" => $value_p->time_06, "time_07" => $value_p->time_07, "time_08" => $value_p->time_08, 
						"time_09" => $value_p->time_09, "time_10" => $value_p->time_10, "time_11" => $value_p->time_11,
						"time_12" => $value_p->time_12, "time_13" => $value_p->time_13, "time_14" => $value_p->time_14,
						"time_15" => $value_p->time_15, "time_16" => $value_p->time_16, "time_17" => $value_p->time_17,
						"time_18" => $value_p->time_18, "time_19" => $value_p->time_19, "time_20" => $value_p->time_20,
						"time_21" => $value_p->time_21, "time_22" => $value_p->time_22, "time_23" => $value_p->time_23,
					);
				} */ 
                foreach ($meteo_values_p as $value_p) {
                $date = $value_p->date;
                ...
                $hourStr = str_pad($hour, 2, '0', STR_PAD_LEFT); // Agregar ceros a la izquierda si es necesario
                $timeKey = "time_$hourStr";

                // Asignar el valor correspondiente al array dinámicamente
                $array_meteo_data_values_p[$date][$latLongKey][$timeKey] = $value_p->$timeKey;
            }
        }
	...
	function list_data_variable($id_sector = 0, $id_station = 0, $id_variable = 0, $id_model = 0){
		...
		$alert_config_air_action_plan_user = $this->AYN_Alert_projects_users_model->get_one_where(array(
		...
		foreach($array_alerts_forecast as $index_alert => $alert){
			...
			$array_alerts_final[] = array(
				"nc_active" => $alert["nc_active"], "nc_name" => $alert["nc_name"], "nc_color" => $alert["nc_color"], "min_value" => $alert["min_value"],
	...
	function get_excel($id_sector = 0){
		...
		$air_stations = $this->Air_stations_model->get_all_where(array(
			"id_air_sector" => $air_sector->id,
			"is_active" => 1,
			"is_forecast" => 1,
			//"is_receptor" => 1,
			...
			foreach($station_variables as $station_variable){
				...
				if($station_variable->id_variable != 9){
					...
					if(in_array(3, $id_models_of_sector)){ // Si el Sector tiene Modelo Numérico
						...
						if($air_record->id){
							$value_p_num = $this->Air_records_values_p_model->get_last_upload_data_1D_by_date(array(
					...
					if(in_array(2, $id_models_of_sector)){ // Modelo NEURONAL (Arima)
						...
						if($air_record->id){
							$value_p_est = $this->Air_records_values_p_model->get_last_upload_data_1D_by_date(array(
								"id_variable" => $station_variable->id_variable,
								"id_record" => $air_record->id,
								//"date" => $date
							))->row();
					...
					if(in_array(1, $id_models_of_sector)){ // Modelo MACHINE LEARNING
						...
						if($air_record->id){
							$value_p_neu = $this->Air_records_values_p_model->get_last_upload_data_1D_by_date(array(
								"id_variable" => $station_variable->id_variable,
								"id_record" => $air_record->id,
								//"date" => $date
							))->row();

<?php
    ...
    class Test_mail_qwe extends MY_Controller{
        ...
        function index(){
            ...
            $send_app_mail = send_app_mail("christopher@ulearn.cl", $email_template->subject, $message, array('cc' => array('christopher@mimasoft.cl','christopher.ulearn@outlook.com')) );

            // $send_app_mail = send_app_mail(implode(',',array('christopher@mimasoft.cl','christopher.ulearn@outlook.com')), $email_template->subject, $message );

...
class Wiki extends MY_Controller {
	...
	function __construct() {
		...
		//$this->id_submodulo_cliente = 17;
		$this->id_modulo_contexto_cliente = 1;
		$this->id_submodulo_contexto_cliente = 2;
    ...
    public function index() {
        ...
        if ($this->login_user->user_type === "staff") {
			...
			$view_data['wiki'] = $this->Wiki_model->get_all()->result();
			$view_data["puede_ver"] = 1;
			$this->template->rander("wiki/inicio", $view_data);

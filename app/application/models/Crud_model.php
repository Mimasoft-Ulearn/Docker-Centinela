...
class Crud_model extends CI_Model {
    ...
    function add_log($client_id, $home_modules_info, $module_id, $project_id = NULL, $action, $item_id = NULL, $item_name = NULL) {

        $id_usuario = $this->Users_model->login_user_id();
        $log_data = array(
            "id_cliente" => $client_id,
            "id_home_modules_info" => $home_modules_info,
            "id_module" => $module_id,
            "id_proyecto" => $project_id,
            "id_usuario" => $id_usuario,
            "action" => $action,
            "datetime" => get_current_utc_time(),
            "item_id" => $item_id,
            "item_name" => $item_name,
        );
        $this->Logs_model->save($log_data);
    }

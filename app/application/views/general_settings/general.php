<div class="col-sm-9 col-lg-10">
    <?php echo form_open(get_uri("general_settings/save_general_settings"), array("id" => "general-settings-form", "class" => "general-form dashed-row", "role" => "form")); ?>
    <div class="panel">
		...
		<div class="panel-body">
            ...
            <input type="hidden" id="id_proyecto_general_setting" name="id_proyecto" />
            ...
            <!--<div class="form-group">
                <label for="dots_numerical_config" class=" col-md-2"><?php echo lang('dots_numerical_config'); ?></label>
                <div class="col-md-10">
                    <?php
                    echo form_dropdown(
                            "dots_numerical_config", array(
                                "1" => lang("dots_numerical_config_opt1"),
                                "2" => lang("dots_numerical_config_opt2")
                            ), $general_settings->thousands_separator, "class='select2'"
                    );
                    ?>
                </div>
            </div>-->
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <?php
                    echo form_dropdown(
                            "language", $language_dropdown, $general_settings->language, "class='select2 mini'"
                    );
                    ?>
                </div>
            </div>
            ...
            <!--
            <div class="form-group">
                <label for="general_color" class=" col-md-2"><?php echo lang('general_color'); ?></label>
                <div class="col-md-10">
                    <?php
                        echo form_input(array(
                            "id" => "general_color",
                            "name" => "general_color",
                            "value" => $general_settings->general_color,
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('#id_proyecto_general_setting').val(id_proyecto);

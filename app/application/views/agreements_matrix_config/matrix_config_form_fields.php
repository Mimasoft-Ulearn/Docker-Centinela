...
<div class="form-group">
    ...
    <?php
		...
		$arraySelected2["fijo_1"] = lang("code");
		...
		$arraySelected2["fijo_3"] = lang("description");
		$array_campos_ocupados[] = "fijo_3";
		
		$arraySelected[] = "fijo_4";
		$arraySelected2["fijo_4"] = lang("period");
		$array_campos_ocupados[] = "fijo_4";
		
		$arraySelected[] = "fijo_5";
		$arraySelected2["fijo_5"] = lang("managing");
		$array_campos_ocupados[] = "fijo_5";

        foreach($campos_agreement_matrix_config as $innerArray){
		...
		$arrayCamposProyecto["fijo_6"] = lang("stakeholders");
    ...
    $(document).ready(function () {
		...
		$('#fields').multiSelect({
			...
			afterSelect: function(value){
				...
				($("<option>"+text+"</option>").attr("value", value).attr('selected', 'selected')).insertBefore($('#fields option[value="fijo_6"]'));

...
(function ($) {
    ...
    $.fn.appTable = function (options) {
		...
		//ESTO ES NUEVO - AGREGADO PARA ELIMINACIÓN DE ARCHIVOS
		var deleteFileConfirmationHandler = function (e) {
            var $deleteButton = $("#confirmFileDeleteButton"),
                    $target = $(e.currentTarget);
            //copy attributes
		...
		//ESTO ES NUEVO - AGREGADO PARA ELIMINACIÓN DE ARCHIVOS
		$('body').find($instance).on('click', '[data-action=delete-fileConfirmation]', deleteFileConfirmationHandler);
